...
const FORM_DOCUMENT_TYPES = new Set(['signed_cr1', 'signed_cr2', 'signed_cr8', 'statement_of_nominal_capital', 'signed_bof1', 'signed_bn2', 'partnership_agreement', 'trust_deed', 'constitution', 'custom_articles'])
